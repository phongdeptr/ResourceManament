...
public class CancelRequest extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String deactiveRequestID = request.getParameter("deleteID");
        ...
        if (dto == null || !dto.isIsActive() || dto.isIsAdmin()) {
            ...
            try {
                dao.cancelRequest(Integer.parseInt(deactiveRequestID));
                request.getRequestDispatcher("RequestHistoryController").forward(request, response);
